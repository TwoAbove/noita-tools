...
const PanelsSettings = () => {
  return (
    <>
      <ConfigTitle title="Panels" subtitle="Choose which info panels you want to see." />
      <ListGroup variant="flush" className="mb-5 shadow">
        ...
        <ListGroup.Item>
          <PanelToggle key="holy-mountain" id="holy-mountain" title="Holy Mountain" />
        </ListGroup.Item>
        <ListGroup.Item>
        ...
        <ListGroup.Item>
          <PanelToggle key="excavationsite-cube" id="excavationsite-cube" title="Excavation Site Cube" />
        </ListGroup.Item>
        {/* <ListGroup.Item>
