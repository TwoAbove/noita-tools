...
var Module = typeof create_noita_random != "undefined" ? create_noita_random : {};
...
[ "_generate_path_map", "_free", "_malloc", "___getTypeName", "__embind_initialize_bindings", "_fflush", "onRuntimeInitialized" ].forEach(prop => {
...
var _generate_path_map = Module["_generate_path_map"] = createExportWrapper("generate_path_map");
...
run();
  ...
  return create_noita_random.ready
}
