...
var create_noita_random = (() => {
  ...
  return (
function(config) {
  var create_noita_random = config || {};
...
[ "_generate_map", "_generate_path_map", "___getTypeName", "__embind_initialize_bindings", "_fflush", "onRuntimeInitialized" ].forEach(prop => {
