...
async function d() {
  ...
  fs.writeFileSync(path.resolve(__dirname, "maps.json"), JSON.stringify(mapCopy, null, 2));
  ...
  fs.writeFileSync(path.resolve(__dirname, "impl.json"), JSON.stringify(impl, null, 2));
