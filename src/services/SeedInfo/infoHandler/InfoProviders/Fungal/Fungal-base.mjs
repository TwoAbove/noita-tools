...
var create_Fungal = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    var wasmBinaryFile;
    if (Module["locateFile"]) {
      wasmBinaryFile = "Fungal-base.wasm";
      if (!isDataURI(wasmBinaryFile)) {
        wasmBinaryFile = locateFile(wasmBinaryFile);
      }
    } else {
      wasmBinaryFile = new URL("Fungal-base.wasm", import.meta.url).href;
    }
    ...
    var ___cxa_is_pointer_type = a0 => (___cxa_is_pointer_type = wasmExports["D"])(a0);
    var calledRun;
