...
-- 1,-1,-1,1,mixed,-1,mixed,mixed,mixed,mixed,-1,mixed
        ...
        for i, entity_file in ipairs(entity_files) do
            if (string.len(entity_file) > 0) then
                ...
                for j = 1, string.len(entity_file) do
                    local letter = string.sub(entity_file, string.len(entity_file) - (j - 1),
                        string.len(entity_file) - (j - 1))
