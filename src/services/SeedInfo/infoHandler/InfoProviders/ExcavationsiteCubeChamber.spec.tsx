...
import { ExcavationsiteCubeChamberInfoProvider } from "./ExcavationsiteCubeChamber";
import { WandInfoProvider } from "./Wand";
import { MapInfoProvider } from "./Map";
import { loadRandom } from "../../../../testHelpers";

describe.skip("ExcavationsiteCubeChamberInfoProvider", () => {
  const tests = [
    {
      seed: 123,
      ans: [],
  ...
  describe("#provide", () => {
    tests.forEach((t, i) => {
      it(`Should generate correct output #${i}`, async () => {
        ...
        const provider = new ExcavationsiteCubeChamberInfoProvider(randoms, mapInfoProvider, wandInfoProvider);
