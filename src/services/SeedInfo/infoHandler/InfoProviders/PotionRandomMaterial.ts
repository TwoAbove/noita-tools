...
export class PotionRandomMaterialInfoProvider extends InfoProvider {
  ...
  CellFactory_GetAllLiquids(include_statics = true, include_particle_fx_materials = false) {
    return this.liquids;
    // const res: string[] = [];
  ...
  CellFactory_GetAllSands(include_statics = true, include_particle_fx_materials = false) {
    return this.sands;
    // const res: string[] = [];
    // for (const m of Object.keys(materials)) {
    // 	const material = materials[m];
