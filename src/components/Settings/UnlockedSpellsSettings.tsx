...
const FlagToggle = (props: { flag: string }) => {
  ...
  const [unlockedSpells, setUnlockedSpells] = useLocalStorage("unlocked-spells", Array(406).fill(true));
...
const UnlockedSpellsSettings = () => {
  const [, setUnlockedSpells] = useLocalStorage("unlocked-spells", Array(406).fill(true));
  const onDrop = (acceptedFiles: File[]) => {
    let newUnlockedSpells = Array(406).fill(true);
