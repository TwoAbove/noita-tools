...
class Excavationsite extends Base {
	...
	g_pixel_scene_04 = [
		{
			...
			background_file:
				'data/biome_impl/excavationsite/machine_1_background.png',
			is_unique: 0
		},
		{
			prob: 0.5,
			...
			background_file:
				'data/biome_impl/excavationsite/machine_2_background.png',
			is_unique: 0
		},
		{
			prob: 0.5,
			...
			background_file:
				'data/biome_impl/excavationsite/machine_3b_background.png',
			is_unique: 0
		},
		{
			prob: 0.5,
			...
			background_file:
				'data/biome_impl/excavationsite/machine_4_background.png',
			is_unique: 0
		},
		{
			prob: 0.5,
			...
			background_file:
				'data/biome_impl/excavationsite/machine_5_background.png',
			is_unique: 0
		},
		{
			prob: 0.5,
	...
	g_pixel_scene_04_alt = [
		...
		},
		{
			...
			visual_file: '',
			background_file:
				'data/biome_impl/excavationsite/receptacle_steam_background.png',
			is_unique: 0
		},
		{
			prob: 0.8,
